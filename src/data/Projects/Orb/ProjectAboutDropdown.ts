...
import smell from '$lib/assets/images/projects/orb/image_(14).png';
import sadistic from '$lib/assets/images/projects/orb/image_(15).png';
import sometimes from '$lib/assets/images/projects/orb/image_(16).png';
...
export const daoDropdownItems: IAboutDropdown[] = [
	{
		name: 'Redondo',
		artist: 'Ygor Alves',
		about: 'Piece made as part of the O.R.B. Collective Exhibition in São Paulo.',
	...
	{
		name: 'sometimes i feel like i’m an elephant on top of a building',
		artist: 'xobaia',
	...
	{
		name: 'to concerning parties: 𝗮 𝗺𝘂𝘀𝘁 𝗿𝗲𝗮𝗱',
		artist: 'estilara',
		about:
