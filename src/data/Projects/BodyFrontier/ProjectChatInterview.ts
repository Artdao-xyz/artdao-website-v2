...
export const bodyFrontierChatInterview1: ChatInterviewData = {
  ...
  messages: [
    { characterId: 'alice-scope', content: 'What themes drive your creative process?' },
    ...
    { characterId: 'alice-scope', content: 'Has software shaped the way you see human identity?' },
    ...
    { characterId: 'alice-scope', content: 'Are we finding a more fluid definition of what it means to be human?' },
    ...
    { characterId: 'alice-scope', content: 'How do digitally altered representations redefine our view of the human form?' },
    ...
    { characterId: 'alice-scope', content: 'What have you learned from blending human and digitally altered forms?' },
...
export const bodyFrontierChatInterview2: ChatInterviewData = {
  ...
  messages: [
    { characterId: 'interviewer', content: 'What themes are present or inspire your work?' },
    ...
    { characterId: 'interviewer', content: 'Do your designs challenge societal conventions about the human body?' },
    ...
    { characterId: 'interviewer', content: 'How are your works related to the human figure and technology?' },
    ...
    { characterId: 'interviewer', content: 'What did you learn about the human body and its alterations through your work?' },
