import FrictionAbout from './FrictionAbout.svelte';
import MarcoDonnarummaAbout from './MarcoDonnarummaAbout.svelte';
import MonicaRikicAbout from './MonicaRikicAbout.svelte';

export const humanCausedErrorFrictionAbout = {
	title: 'Friction is not failure, it is where the system reveals itself',
	subtitle: '',
	text: FrictionAbout
};
