...
export const subconsciousMediaAbout1 = {
    title: 'digital synchronicity',
    subtitle: '',
    text: SubconsciousMediaAbout1
};
...
export const subconsciousMediaAbout2 = {
    title: 'Vidal HERRERA',
    subtitle: '',
    text: SubconsciousMediaAbout2
};

export const subconsciousMediaAbout2Images = [
    '/media/subconscious-media/about-2.webp',
    '/media/subconscious-media/about-3.webp'
];

// Third About Section - GREGORio nash
export const subconsciousMediaAbout3 = {
    title: 'GREGORio nash',
    subtitle: '',
    text: SubconsciousMediaAbout3
};
