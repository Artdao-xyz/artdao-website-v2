...
export const textCardItemOne: ITextCardItem = {
	projectName: 'orb',
	projectType: 'artworks',
	title: 'type a big title here',
	...
	texts: [
		...
		'Maecenas nec diam vel sem imperdiet vestibulum. Maecenas maximus volutpat augue, id dapibus odio hendrerit sed. Nunc ac nisi nec lectus malesuada dignissim vitae eu urna. Fusce tempus accumsan nisl. Donec elementum tortor felis, at mattis mauris imperdiet a. Phasellus id dui sed lacus consequat consectetur. Vestibulum sed pretium massa. Duis maximus molestie nibh sodales rutrum. Donec eleifend tempus dui vitae pulvinar. Nam urna ligula, volutpat et condimentum imperdiet, fermentum id erat. Nam maximus metus enim, lobortis hendrerit orci placerat ac. Sed nibh odio, ultricies in mi sit amet, porttitor porta elit. Nullam eleifend nec ex nec ullamcorper. Curabitur venenatis eu dui eget ultricies.',
		'Maecenas nec diam vel sem imperdiet vestibulum. Maecenas maximus volutpat augue, id dapibus odio hendrerit sed. Nunc ac nisi nec lectus malesuada dignissim vitae eu urna. Fusce tempus accumsan nisl. Donec elementum tortor felis, at mattis mauris imperdiet a. Phasellus id dui sed lacus consequat consectetur. Vestibulum sed pretium massa. Duis maximus molestie nibh sodales rutrum. Donec eleifend tempus dui vitae pulvinar. Nam urna ligula, volutpat et condimentum imperdiet, fermentum id erat. Nam maximus metus enim, lobortis hendrerit orci placerat ac. Sed nibh '
	]
};

export const textCardItemTwo: ITextCardItem = {
...
export const textCardItemThree: ITextCardItem = {
	projectName: 'Misfits',
	projectType: 'Music',
	title: 'this is horror punk',
	subtitle: 'all hell breaks loose',
	texts: [
		'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at mi vitae nibh faucibus facilisis. Pellentesque porta dui sodales mattis convallis. Nunc vel euismod eros, in facilisis tortor. Suspendisse porttitor sem vitae consequat ornare. Quisque augue nisi, consequat eleifend massa aliquet, maximus ultricies tortor. Vestibulum dictum massa tellus, ut pellentesque metus cursus id. Fusce pellentesque interdum lectus, quis molestie leo auctor id. Ut fringilla sem in tortor gravida, eget eleifend nisl placerat.',
		'Maecenas nec diam vel sem imperdiet vestibulum. Maecenas maximus volutpat augue, id dapibus odio hendrerit sed. Nunc ac nisi nec lectus malesuada dignissim vitae eu urna. Fusce tempus accumsan nisl. Donec elementum tortor felis, at mattis mauris imperdiet a. Phasellus id dui sed lacus consequat consectetur. Vestibulum sed pretium massa. Duis maximus molestie nibh sodales rutrum. Donec eleifend tempus dui vitae pulvinar. Nam urna ligula, volutpat et condimentum imperdiet, fermentum id.'
	]
