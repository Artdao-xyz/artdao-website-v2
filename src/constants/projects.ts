...
export const projects: Project[] = [
        ...
        },
        {
                ...
                artworks: ["Body Frontier Artwork 1", "Body Frontier Artwork 2", "Body Frontier Artwork 3"],
                quote: "\"3D allows me to create worlds and characters, and to explore my identity through avatars that slowly transform, mutating between different elements.\"",
        },
        {
                ...
                artworks: ["Memetic Rubble Artwork 1", "Memetic Rubble Artwork 2", "Memetic Rubble Artwork 3"],
                quote: "\"Taking memes and processing them through AI, transforming them into something new is what makes memes exceptional. They lack ownership — inherently meant to be shared, remixed, and transformed by anyone.\"",
        },
        {
                ...
                artworks: ["Subconscious Media Artwork 1", "Subconscious Media Artwork 2", "Subconscious Media Artwork 3"],
                quote: "\"More tools gives the possibility to better express what you don't quite know what it is. Even if you are unsure of the path, the important thing is not to lose what guides you, the essential, what really matters.\"",
        },
        {
                ...
                artworks: ["Digital Archaeology Artwork 1", "Digital Archaeology Artwork 2", "Digital Archaeology Artwork 3"],
                quote: "We are constantly bombarded by new media — Yet, I remain influenced by the aesthetics of the past. Limitations offer a form of comfort when creating art.",
        }
];