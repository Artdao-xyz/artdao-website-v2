	...
	<div class="w-[30%] flex justify-end h-full">
		<div class="w-full h-full relative">
			<button
				...
				class="{index === 0
					? 'z-40'
					: 'z-0'} w-[48%] h-[50%] laptopM:h-[55%] laptopL:h-[55%] bigScreen:h-[40%] bg-color-white p-5 flex flex-col gap-2.5 rounded-20 rotate-[-15deg] absolute top-0 left-[4%] cursor-pointer hover:scale-[101%] border border-color-black"
			>
				<img
					src={images[0].image}
			...
			<button
				...
				class="{index === 1
					? 'z-40'
					: 'z-0'} w-[48%] h-[50%] laptopM:h-[55%] laptopL:h-[55%] bigScreen:h-[40%] bg-color-white p-5 flex flex-col gap-2.5 rounded-20 rotate-[15deg] absolute top-0 right-6 cursor-pointer hover:scale-[101%] border border-color-black"
			>
				<img
					src={images[1].image}
					alt="Polaroid Gallery Item"
			...
			<button
				...
				class="{index === 2
					? 'z-40'
					: 'z-0'} w-[71%] xl:max-w-[18rem] laptopM:max-w-[17rem] macBook:max-w-[28rem] h-[50%] laptopM:h-[55%] laptopL:h-[55%] bigScreen:h-[40%] bg-color-white p-5 flex flex-col gap-2.5 rounded-20 rotate-[15deg] absolute top-[33%] right-[1%] cursor-pointer hover:scale-[101%] border border-color-black"
			>
				<img
					src={images[2].image}
					alt="Polaroid Gallery Item"
					class="object-cover h-[65%] macBook:h-[75%] laptopL:h-[70%] bigScreen:h-[80%] w-full"
				/>
			...
			<button
				...
				class="{index === 3
					? 'z-40'
					: 'z-0'} w-[47.5%] xl:max-w-[12rem] h-[80%] laptopM:h-[90%] macBook:h-[85%] laptopL:h-[80%] bigScreen:h-[70%] bg-color-white p-5 flex flex-col gap-2.5 rounded-20 rotate-[-15deg] absolute top-[30%] left-[8%] cursor-pointer hover:scale-[101%] border border-color-black"
			>
				<img
					src={images[3].image}
					alt="Polaroid Gallery Item"
					class="object-cover h-[80%] macBook:h-[90%] w-full"
				/>
