            ...
            {#if selectedProjectIndexes.length > 0}
                <div class="w-full mb-8 flex justify-center lg:hidden" transition:fade={{ duration: 400 }}>
                    <div class="w-full max-w-2xl">
                        <a href={projects[selectedProjectIndexes[0]].pagePath} rel="noopener noreferrer">
                            <img 
                                src={projects[selectedProjectIndexes[0]].thumbnailPathMobile} 
                                alt={`${projects[selectedProjectIndexes[0]].title} thumbnail`}
