...
<SectionContainer hasPadding={false} isOverflow={false}>
	...
	>
		...
		>
			<h1
				class="font-neue text-[2.5rem] sm:text-[4.375rem] macBook:text-[6.25rem] xlScreen:text-[10rem] font-semibold leading-[3.4375rem] sm:leading-[5rem] laptopM:leading-[6.5625rem] tracking-[0.0975rem] uppercase"
			>
				{name}
			</h1>
			<div
